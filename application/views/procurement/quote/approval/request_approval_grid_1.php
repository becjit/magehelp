...
<!--        <script type="text/javascript" src="http://jzaefferer.github.com/jquery-validation/jquery.validate.js"></script>-->
       ...
       $( "#dialog-form" ).dialog({
                                ...
                                open: function(){
                                     ...
                                     $( "#tabs" ).tabs({
                                        ...
                                        load: function(event,ui){
                                            ...
                                            $("#lineItems").jqGrid({
                                                url:'index.php/procurement/populateRFQItems?q=2&quoteId='+myGrid.getGridParam('selrow'),
                                                datatype: 'json',
        ...
        myGrid.jqGrid({
                    url:'index.php/procurement/populateRFQ?status='+'waitingforapproval',
                    datatype: 'json',
                    mtype: 'GET',
...
//                        {name:'owner', index:'owner', width:140, align:'right',editable:true,editoptions:{size:"20",maxlength:"30"}},
                    ...
                    subGridRowExpanded: function(subgrid_id, row_id) {
                            ...
                            jQuery("#"+subgrid_table_id).jqGrid({
                                    url:'index.php/procurement/populateRFQItems?q=2&quoteId='+row_id,
                                    datatype: 'json',
                                    colNames:['Product','Quantity','Need By Date','Unit Price','Estimated Value','Notes'],
                                    colModel :[ 
                                        {name:'name', index:'name',editable:false, width:120, align:'right'},
