                                        ...
                                        beforeActivate: function (event,ui){
                                         ...
                                         load: function(event,ui){
                                            ...
                                            $("#lineItems").jqGrid({
                                                ...
                                                colNames:['Product id','Product','Quantity','Received','Returned','Not Deliver','Need By Date','Price','Ordered Value','Received Value','Returned Value'/*'Notes'*/],
                                                colModel :[ 
                                                    ...
                                                    {name:'cnbd_quantity', index:'cnbd_quantity', editable:false,width:60, align:'right'},
...
//                        {name:'owner_name', index:'owner_name',editable:false, width:80, align:'right'},
                    ...
                    subGridRowExpanded: function(subgrid_id, row_id) {
                            ...
                            jQuery("#"+subgrid_table_id).jqGrid({
                                    ...
                                    datatype: 'json',
                                    colNames:['Product Id','Product','Quantity','Received','Returned','Could Not Deliver','Need By Date','Unit Price','Estimated Value','Received Value','Returned Value','Notes'],
                                    colModel :[ 
                                        {name:'product_id', index:'product_id',editable:false, hidden:true},
                                        ...
                                        {name:'cnbd_quantity', index:'cnbd_quantity', editable:false,width:50, align:'right'},
        ...
        $( "#dialog-form-cnbd" ).dialog({
                ...
                click:function() {
                    ...
                    if (isvalid){
                       $.ajax({
                           ...
                           data:{
                               order_line_id:order_line_id,
                               cnbd_quantity:$("#cnbd_quantity").val(),
            ...
            open: function(event,ui){
                ...
                var oper = $(this).data('grid_data').oper;
                if (oper=='edit'){
                    $("#cnbd_quantity").val($("#"+grid).getCell(order_line_id,'cnbd_quantity'));
                }
                ...
                <fieldset style="border:1px solid #A6C9E2">
                     ...
                     <div class="row">
                        <div class="column">
                            <div class="field">
                                ...
                                <div class="valuediv" name="cnbd_qty" id="cnbd_qty" ></div>
                    ...
                    <div class="row">
                        <div class="column">
                             ...
                             <div class="field">
                                <label for="discount" class="labeldiv">Discount:</label>  
                                <input id="discount" name="discount"/><span style="color:green;font-weight:bold"> %</span>
                        ...
                        <div class="column">
                            <div class="field">
                                ...
                                <input id="free_items" name="free_items" />
...
<!--                    <div id="returned_notes_cntnr" class="row single-column-row" style="display:none">
        ...
        <div id ="dialog-form-cnbd">
            <div id ="status-message-li-cndb" class="ui-corner-all">
            ...
            <form id="cnbdItemForm">
                    ...
                    <div id="cnbd_quantity_cntnr" class="row single-column-row">
                        <div class="column quote-column single-column">
                            <div class="field">
                                <label for="cnbd_quantity" class="labeldiv">Quantity:</label>  
                                <input id="cnbd_quantity" name="cnbd_quantity" class="required"/>
                    ...
                    <div id="cnbd_notes_cntnr" class="row single-column-row">
                        <div class="column quote-column single-column">
                            <div class="field">
