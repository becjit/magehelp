                                     ...
                                     $( "#tabs" ).tabs({ 
                                        ...
                                        beforeActivate: function (event,ui){
                                         ...
                                         load: function(event,ui){
                                            ...
                                            addCustomButtonsToOrderItemGrid('lineItems','pagerPk');
                                            ...
                                            var btns = {add:true,edit:true,data:{type:'advance',order_id:order_id}};
...
//                        {name:'owner_name', index:'owner_name',editable:false, width:80, align:'right'},
                    ...
                    subGridRowExpanded: function(subgrid_id, row_id) {
                            ...
                            var settingsObj ={grid_id:subgrid_table_id,pager:pager_id};
                            
                            prepareOrderItemsGrid(settingsObj,{orderId:row_id},false,{},{needed_by_date:true,returned_value:true});
                            $("#"+subgrid_table_id).navGrid("#"+pager_id,{edit:false,add:false,del:false,search:false,view:true},{},{},{},{},{});
                    }
